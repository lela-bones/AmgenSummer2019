...
np.savetxt('../Results/Pred{}_{}_{}_{}.csv'.format(split, batch_size, hidden_size, lr_rate), pred.cpu().data.numpy())
np.savetxt('../Results/labels{}_{}_{}_{}.csv'.format(split, batch_size, hidden_size, lr_rate), labels.cpu().data.numpy())
# visualization loss
plt.ylim(0, 2.5)
plt.plot(losses)
